...
class AnimeUpcomingAdapter extends TypeAdapter<AnimeUpcoming> {
  @override
  final int typeId = 2;

  @override
  AnimeUpcoming read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, AnimeUpcoming obj) {
    writer
      ..writeByte(11)
      ..writeByte(0)
      ..write(obj.imageUrl)
